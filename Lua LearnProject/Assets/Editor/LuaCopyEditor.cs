...
public class LuaCopyEditor : Editor
{
    ...
    public static void CopyLuaToTxt()
    {
        ...
        for (int i = 0; i < newFileName.Count; i++)
        {
            ...
            AssetImporter importer = AssetImporter.GetAtPath(newFileName[i].Substring(newFileName[i].IndexOf("Assets")));
            if (importer != null)
